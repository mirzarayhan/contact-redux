...
let SignInForm = props => 
  ...
  const validate = val => { const errors = {};
    if (!val.firstName) {
    ...
    if (!val.email) { console.log('email is required'); errors.email = 'Required';
    } else if (!/^.+@.+$/i.test(val.email)) { 
      console.log('email is invalid'); errors.email = 'Invalid email address';
    }
    if (!val.age) {
      errors.age = 'Required'
    ...
    return (
      <div className="App">
        ...
        <div className="container">
          <p className="App-intro"> Contact Form
          </p>
